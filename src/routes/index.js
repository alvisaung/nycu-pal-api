...
const memberTypeController = require("../controllers/memberTypeController.js");
...
router.route("/member-type").get(memberTypeController.get).put(upload, memberTypeController.createOrUpdate).delete(upload, memberTypeController.delete);
